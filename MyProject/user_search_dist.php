...
{ 
							...
							$q="select $search from addstatus where state='$var';";
							if($result=mysqli_query($con,$q))
							{
								if(mysqli_num_rows($result)>0)
								{
									...
									{?>
									<option type="text"><?php echo $row[$search];?></option>
							<?php 
									}
								}
								else
	...
	<div class = "cointener">
		...
		<div class = "rightside">
			<section class="section">
				<form action="user_search_city.php" method="post">
					<label>Select Dist</label>
					<select name="dist">
						<?php f1('dist');?>
					</select></br>
					<div class="clearfix">
					...
					<label>State:<?php echo $_SESSION['state'];?></label>
				</form>	
			</section>
