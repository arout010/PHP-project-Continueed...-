...
<html>
	...
	<div class = "cointener">
		...
		<section class="section">
				<center><h2>Update Satus</h2></br></center>
				<form name="form" method="post" action="Update_stats.php" >
				...
				<input type="text" name ="Source_location" placeholder="Enter your Source_location" />
				<label><b>Destination location</b></label>
				<input type="text" name ="Destination_location" placeholder="Enter your Destination_location" />
				<label><b>Total K.M</b></label>
				<input type="text" name ="Distance" placeholder="Enter Total Distance(in k.m.)" />
				<label><b>Total Time Taken</b></label>
				<input type="text" name ="Time" placeholder="Enter Total Time taken(in Hr.)" />	
				<div class="clearfix">
